...
function PrivateRoute({ children }: { children: React.ReactNode }) {
  ...
  if (!user || user.id === 'anonymous') return <Navigate to="/login" />;
  return <>{children}</>;
}
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/data-hub" element={<PrivateRoute><DataHub /></PrivateRoute>} />
      <Route path="/data-hub/:id" element={<PrivateRoute><MasterPropertyDetail /></PrivateRoute>} />
      <Route path="/settings" element={<PrivateRoute><Settings /></PrivateRoute>} />
      <Route path="/crm/contacts" element={<PrivateRoute><Contacts /></PrivateRoute>} />
      <Route path="/crm/contacts/:id" element={<PrivateRoute><ContactDetail /></PrivateRoute>} />
      <Route path="/crm/companies" element={<PrivateRoute><Companies /></PrivateRoute>} />
      <Route path="/crm/companies/:id" element={<PrivateRoute><CompanyDetail /></PrivateRoute>} />
      <Route path="/crm/deals" element={<PrivateRoute><Deals /></PrivateRoute>} />
      <Route path="/crm/deals/:id" element={<PrivateRoute><DealDetail /></PrivateRoute>} />
      <Route path="/documents/generate" element={<PrivateRoute><DocumentGenerator /></PrivateRoute>} />
      <Route path="/listing-sites" element={<PrivateRoute><ListingSites /></PrivateRoute>} />
