                ...
                {valuation.pricing_scenarios && (
                  <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 bg-gray-50/50">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {execSummaryHistory.length > 0 && (
                            <p className="text-xs text-gray-500">{execSummaryHistory.length} document{execSummaryHistory.length !== 1 ? 's' : ''} generated</p>
                          )}
                        </div>
                      </div>
                      <Button
                      ...
                      >
                        {savingExecSummary ? 'Saving...' : 'New Summary'}
                      </Button>
                    </div>
                    ...
                    {execSummaryHistory.length > 0 ? (
                      <div className="divide-y divide-gray-100">
                        {execSummaryHistory.map((item) => (
                          <div
                            ...
                            onClick={() => setExecSummaryPreviewUrl(
                              execSummaryPreviewUrl === item.url ? null : item.url
                            )}
                          >
                            {/* PDF icon */}
                            <div className={`shrink-0 w-10 h-10 rounded-lg flex items-center justify-center ${
                              execSummaryPreviewUrl === item.url ? 'bg-red-100' : 'bg-gray-100'
                            }`}>
                              <svg className={`w-5 h-5 ${execSummaryPreviewUrl === item.url ? 'text-red-600' : 'text-gray-500'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-sm font-medium text-gray-900 truncate">{item.ownerName}</p>
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              {execSummaryPreviewUrl === item.url && (
                                <span className="text-xs font-medium text-red-600 bg-red-50 px-2 py-0.5 rounded">Viewing</span>
                              )}
                              <a
                                href={item.url}
                                target="_blank"
                      ...
                      <div className="px-5 py-8 text-center">
                        ...
                        <p className="text-sm text-gray-500">No executive summaries yet</p>
                    ...
                    {execSummaryPreviewUrl && (
                      <div className="border-t border-gray-200">
                        <div className="flex items-center justify-between bg-gray-50 px-5 py-2 border-b border-gray-100">
