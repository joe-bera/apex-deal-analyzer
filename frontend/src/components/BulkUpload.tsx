...
const DB_FIELDS: { field: string; label: string; category: string }[] = [
  ...
  { field: 'occupancy', label: 'Occupancy (Owner/Tenant)', category: 'Status' },
...
const AUTO_MAP_HINTS: Record<string, string[]> = {
  ...
  percent_leased: ['percent leased', 'leased', 'leased %'],
  occupancy: ['occupancy', 'occupied', 'owner occupied', 'tenant occupied'],
